            ...
            >
                ...
                >
                    ...
                    <input
                        ...
                        disabled
                        autocomplete="off"
                        placeholder="{{ __('Configured with PHONE_CALL_AGENT_ELEVENLABS_WEBHOOK_SECRET') }}"
                        value=""
                    >
                    <p class="mt-1 text-xs opacity-60">
                        {{ __('Configure this signing secret in the server environment. Unsigned webhooks are rejected.') }}
                    </p>
                </div>
            </div>
        </x-card>
