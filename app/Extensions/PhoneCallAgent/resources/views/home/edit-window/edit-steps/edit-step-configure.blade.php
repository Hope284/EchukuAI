            ...
            <div class="flex flex-col gap-7">
                <div>
                    ...
                    >
                        ...
                        <optgroup label="Standard Cloud Voices">
                            <option value="Google.en-US-Standard-B">English US (Male)</option>
                            <option value="Google.en-US-Standard-C">English US (Female)</option>
                            <option value="Google.en-GB-Standard-A">English GB (Female)</option>
                            <option value="Google.fr-FR-Standard-A">French (Female)</option>
                            <option value="Google.de-DE-Standard-A">German (Female)</option>
                            <option value="Google.es-ES-Standard-A">Spanish (Female)</option>
                        </optgroup>
                    </x-forms.input>
                </div>
            </div>
