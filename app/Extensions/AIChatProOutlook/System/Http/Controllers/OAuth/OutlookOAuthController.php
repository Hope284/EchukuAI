...
class OutlookOAuthController extends Controller
{
    ...
    public function redirect(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Log::error('[DZEVA Connector] Outlook authorization failed to start.', ['error' => $exception->getMessage()]);
    ...
    public function callback(Request $request): RedirectResponse|View
    {
        ...
        try {
            ...
            Log::warning('[DZEVA Connector] Outlook authorization callback failed.', ['error' => $exception->getMessage()]);
