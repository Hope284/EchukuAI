...
class AIChatProOutlookServiceProvider extends ServiceProvider implements UninstallExtensionServiceProviderInterface
{
    ...
    private function registerRoutes(): static
    {
        ...
        $router->group([
            ...
            $router->get('outlook/redirect', [OutlookOAuthController::class, 'redirect'])->middleware('ai-chat-pro.connector:outlook')->name('outlook.redirect');
            $router->get('outlook/callback', [OutlookOAuthController::class, 'callback'])->middleware('ai-chat-pro.connector:outlook')->name('outlook.callback');
        });
