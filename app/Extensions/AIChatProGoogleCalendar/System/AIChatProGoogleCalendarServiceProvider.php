...
class AIChatProGoogleCalendarServiceProvider extends ServiceProvider implements UninstallExtensionServiceProviderInterface
{
    ...
    private function registerRoutes(): static
    {
        ...
        $router->group([
            ...
            $router->get('google-calendar/redirect', [GoogleCalendarOAuthController::class, 'redirect'])->middleware('ai-chat-pro.connector:google_calendar')->name('google-calendar.redirect');
            $router->get('google-calendar/callback', [GoogleCalendarOAuthController::class, 'callback'])->middleware('ai-chat-pro.connector:google_calendar')->name('google-calendar.callback');
        });
