...
class GoogleDriveOAuthController extends Controller
{
    ...
    public function redirect(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Log::error('[DZEVA Connector] Drive authorization failed to start.', ['error' => $exception->getMessage()]);
    ...
    public function callback(Request $request): RedirectResponse|View
    {
        ...
        try {
            ...
            Log::warning('[DZEVA Connector] Drive authorization callback failed.', ['error' => $exception->getMessage()]);
