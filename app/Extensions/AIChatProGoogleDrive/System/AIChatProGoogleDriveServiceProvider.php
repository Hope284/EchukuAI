...
class AIChatProGoogleDriveServiceProvider extends ServiceProvider implements UninstallExtensionServiceProviderInterface
{
    ...
    private function registerRoutes(): static
    {
        ...
        $router->group([
            ...
            $router->get('google-drive/redirect', [GoogleDriveOAuthController::class, 'redirect'])->middleware('ai-chat-pro.connector:google_drive')->name('google-drive.redirect');
            $router->get('google-drive/callback', [GoogleDriveOAuthController::class, 'callback'])->middleware('ai-chat-pro.connector:google_drive')->name('google-drive.callback');
        });
