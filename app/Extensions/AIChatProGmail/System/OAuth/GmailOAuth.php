...
class GmailOAuth
{
    ...
    public function __construct(?array $config = null)
    {
        ...
        // Non-secret settings may be managed in the dashboard; secrets stay in the environment.
    ...
    private function assertConfigured(): void
    {
        if (empty($this->config['client_id']) || empty($this->config['client_secret'])) {
            throw new RuntimeException('Connector OAuth credentials are not configured.');
        }
    }
