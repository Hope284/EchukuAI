...
class AIChatProGmailServiceProvider extends ServiceProvider implements UninstallExtensionServiceProviderInterface
{
    ...
    private function registerRoutes(): static
    {
        ...
        $router->group([
            ...
            $router->get('gmail/redirect', [GmailOAuthController::class, 'redirect'])->middleware('ai-chat-pro.connector:gmail')->name('gmail.redirect');
            $router->get('gmail/callback', [GmailOAuthController::class, 'callback'])->middleware('ai-chat-pro.connector:gmail')->name('gmail.callback');
        });
