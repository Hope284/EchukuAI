...
class GmailOAuthController extends Controller
{
    ...
    public function redirect(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Log::error('[DZEVA Connector] Gmail authorization failed to start.', ['error' => $exception->getMessage()]);
    ...
    public function callback(Request $request): RedirectResponse|View
    {
        ...
        try {
            ...
            Log::warning('[DZEVA Connector] Gmail authorization callback failed.', ['error' => $exception->getMessage()]);
