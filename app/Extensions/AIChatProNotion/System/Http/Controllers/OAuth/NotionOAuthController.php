...
class NotionOAuthController extends Controller
{
    ...
    public function redirect(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Log::error('[DZEVA Connector] Notion authorization failed to start.', ['error' => $exception->getMessage()]);
    ...
    public function callback(Request $request): RedirectResponse|View
    {
        ...
        try {
            ...
            Log::warning('[DZEVA Connector] Notion authorization callback failed.', ['error' => $exception->getMessage()]);
