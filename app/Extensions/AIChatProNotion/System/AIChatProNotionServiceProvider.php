...
class AIChatProNotionServiceProvider extends ServiceProvider implements UninstallExtensionServiceProviderInterface
{
    ...
    private function registerRoutes(): static
    {
        ...
        $router->group([
            ...
            $router->get('notion/redirect', [NotionOAuthController::class, 'redirect'])->middleware('ai-chat-pro.connector:notion')->name('notion.redirect');
            $router->get('notion/callback', [NotionOAuthController::class, 'callback'])->middleware('ai-chat-pro.connector:notion')->name('notion.callback');
        });
