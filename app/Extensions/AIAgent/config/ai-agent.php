...
return [
    ...
    'tools' => [
        'generate_report' => [
            ...
            'action'      => \App\Extensions\AIAgent\System\Actions\GenerateReportAction::class,
            'parameters'  => [
                'type'       => 'object',
                'properties' => [
                    'date_range' => [
        ...
        'memory' => [
            ...
            'action'      => \App\Extensions\AIAgent\System\Actions\MemoryAction::class,
            'parameters'  => [
                'type'       => 'object',
                'properties' => [
                    'operation' => [
    ...
    'workflow_templates' => [
        'daily_report' => [
			...
			'avatar'	  => '/vendor/ai-agent/images/agents/agent-1.png',
			'color'		  => '#cecff2',
            'tags'        => ['reports'],
			'featured'    => true,
            'config'      => [
