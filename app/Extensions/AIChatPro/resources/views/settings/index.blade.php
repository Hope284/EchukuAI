...
@section('settings')
	...
	>
		...
		@if (
			\App\Helpers\Classes\MarketplaceHelper::isRegistered('ai-chat-pro-smart-image') ||
			\App\Helpers\Classes\MarketplaceHelper::isRegistered('ai-chat-pro-entity-highlight')
		)
			<x-form-step
				auto-increment
