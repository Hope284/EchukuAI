    ...
    public function data(): array
    {
        ...
        $menu = [
            ...
            'ext_phone_call_agent' => [
                ...
                'type'             => 'item',
                'extension'        => true,
                'active_condition' => ['dashboard.phone-call-agent.*'],
            ...
            'ext_phone_call_agent_dashboard' => [
                ...
                'type'             => 'item',
                'extension'        => true,
                'active_condition' => ['dashboard.phone-call-agent.index'],
                'show_condition'   => MarketplaceHelper::isRegistered('phone-call-agent'),
            ],
            'ext_phone_call_agent_history' => [
                ...
                'type'             => 'item',
                'extension'        => true,
                'active_condition' => ['dashboard.phone-call-agent.history'],
                'show_condition'   => MarketplaceHelper::isRegistered('phone-call-agent'),
            ],
            'ext_phone_call_agent_new' => [
                ...
                'type'             => 'item',
                'extension'        => true,
                'active_condition' => ['dashboard.phone-call-agent.new'],
                'show_condition'   => MarketplaceHelper::isRegistered('phone-call-agent'),
            ],
            ...
            'ai_agent' => [
                ...
                'show_condition' => Route::has('dashboard.user.ai-agent.dashboard'),
            ],
            'ai_agent_dashboard' => [
                'parent_key'       => 'ai_agent',
    ...
    public function mergeExtensionMenu($menu)
    {
        ...
        $menu = array_merge($menu, [
            ...
            'phone_call_agent_settings_extension' => [
                ...
                'type'             => 'item',
                'extension'        => true,
                'active_condition' => ['dashboard.phone-call-agent.admin.settings'],
            ...
            'ext_ai_agent_settings' => [
                ...
                'show_condition' => Route::has('dashboard.admin.ai-agent.settings'),
                'is_admin'       => true,
            ],
            'ext_ai_agent_gmail_settings' => [
                ...
                'show_condition' => Route::has('dashboard.admin.ai-agent.gmail.settings'),
                'is_admin'       => true,
            ],
            'ext_ai_agent_outlook_settings' => [
                ...
                'show_condition' => Route::has('dashboard.admin.ai-agent.outlook.settings'),
                'is_admin'       => true,
            ],
        ]);
